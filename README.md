...
![Airbnb Console](/images/image_airbnb_console.png)

----------
## Menu:

- [➤ Description HBNB](https://github.com/francois0002/holbertonschool-AirBnB_clone#-description)
- [➤ The console](https://github.com/francois0002/holbertonschool-AirBnB_clone#-the-console)
- [➤ Installation](https://github.com/francois0002/holbertonschool-AirBnB_clone#-installation)
- [➤ How to use](https://github.com/francois0002/holbertonschool-AirBnB_clone#-how-to-use)
- [➤ Examples](https://github.com/francois0002/holbertonschool-AirBnB_clone#-examples)
- [➤ Tests](https://github.com/francois0002/holbertonschool-AirBnB_clone#-tests)
- [➤ License](https://github.com/francois0002/holbertonschool-AirBnB_clone#-license)

----------

## ➤ Description:

This Airbnb Clone is a complete full-stack web application, integrating a MySQL database and Flask RESTful API with a dynamic HTML5/CSS3/jQuery front-end.
...
The first piece is to manipulate a powerful storage system. This storage engine will give us an abstraction between “My object” and “How they are stored and persisted”. This means: from your console code (the command interpreter itself) and from the front-end and RestAPI that will build later.

With this console, we are able to:
...
In order to install the console, clone this repository in your terminal:

```
$ git clone https://github.com/francois0002/holbertonschool-AirBnB_clone.git
$ cd AirBnB_clone
```
----------
...
### Commands
You will find bellow a list of available commands :
